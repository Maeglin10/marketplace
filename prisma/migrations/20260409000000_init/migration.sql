...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('ORDER_PLACED', 'ORDER_STATUS_UPDATE', 'NEW_MESSAGE', 'NEW_REVIEW', 'DISPUTE_UPDATE', 'PAYMENT_RECEIVED');
...
-- CreateIndex
CREATE INDEX "Conversation_targetId_idx" ON "Conversation"("targetId");

-- CreateIndex
CREATE INDEX "Conversation_orderId_idx" ON "Conversation"("orderId");

-- CreateIndex
CREATE UNIQUE INDEX "Conversation_initiatorId_targetId_orderId_key" ON "Conversation"("initiatorId", "targetId", "orderId");
...
-- AddForeignKey
ALTER TABLE "Conversation" ADD CONSTRAINT "Conversation_targetId_fkey" FOREIGN KEY ("targetId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
