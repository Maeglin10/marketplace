...
export default function GlobalError({ error, reset }: ErrorProps) {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 flex flex-col items-center justify-center px-4">
      {/* Animated icon */}
      <div className="mb-8">
        <div className="w-24 h-24 rounded-full bg-red-50 dark:bg-red-900/20 flex items-center justify-center animate-pulse">
          <svg
      ...
      <div className="text-center space-y-3 mb-10 max-w-md">
        ...
        {error?.digest && (
          <p className="text-xs text-gray-400 dark:text-gray-500 font-mono bg-gray-50 dark:bg-gray-900 px-3 py-1.5 rounded-md inline-block border border-gray-100 dark:border-gray-800">
      ...
      {/* Subtle footer hint */}
      <p className="mt-12 text-xs text-gray-300 dark:text-gray-600">
